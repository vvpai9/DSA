...
int main()
{
    ...
    do
    {
        printf ("\n1 -> Insert an element at the front of the queue\n2 -> Insert an element at the rear of the queue\n3 -> Delete an element at the front of the queue\n4 -> Delete an element at the rear of the queue\n5 -> Display entire queue\n0 -> Exit\n\nEnter your choice: ");
        scanf ("%d", &choice);
        switch (choice)
        {
            case 1 :
